...
<nav>
    <ul>
        ...
        <div class="contenedor" id="contForm">
            <form action="create" method="post" id="formCrearCuenta">
                <h1><center>Actualizar Datos</center><h1>
                 <label class="formulario-label">Id Cliente:</label>
                <input type="text" value="" class="formulario-input"  disable name="idCliente" required>
                
                <label class="formulario-label">Código Postal:</label>
                <input type="text" value=""  class="formulario-input"  name="codigoPostal" maxlength="5" required>
                <label class="formulario-label">Dirección Exacta:</label>
                <input type="text" value="" class="formulario-input" name="direccionExacta" maxlength="50" required onkeypress="return validarLetras(event)">
                <label class="formulario-label">Id Distrito:</label>
                <input type="text" value="" class="formulario-input" name="idDistrito"  maxlength="50" required onkeypress="return validarLetras(event)">
                <label class="formulario-label">Id Cuenta</label>
                <input type="text" value="" class="formulario-input" name="idCuenta" id="telefono" onkeypress="return validarNumeros(event)" maxlength="8" required>
                <input type="submit" class="btn" value="Actualizar" id="btnCrear">
            </form> 
        </div>
    </body>
    <footer>
